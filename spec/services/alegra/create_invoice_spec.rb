...
describe Alegra::Credits::CreateInvoice do
  ...
  let(:credit_billing) { create(:credit_billing, quantity: 2_000, unit_price: 120000, discount_percentage: 10, payment_date: '2016-10-27'.to_date) }
  ...
  it 'should create an invoice in alegra' do
    VCR.use_cassette('alegra_create_credits_invoice') do
      ...
      service.call(trader_user: user, payment_method: 'cash', credit_billing: credit_billing )
