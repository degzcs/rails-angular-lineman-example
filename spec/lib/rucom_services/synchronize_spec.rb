...
describe RucomServices::Synchronize do
  ...
  describe 'When look for an Authorized Provider' do
    context '#call' do
    ...
    context '#rucom_exist?' do
      ...
      context 'When rucom does not exist' do
  ...
  describe 'When look for a Trader (company)' do
    context '#call' do
      it 'executes sucessfully' do
    ...
    context '#company_rucom_exist?' do
      ...
      context 'When rucom already exist in our database' do
        it 'returns true as response' do
    ...
    it 'should not create a company because it cannot trade gold' do
