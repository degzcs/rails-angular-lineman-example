...
class Sale::ProofOfSale::DrawPDF < Prawn::Document
  ...
  def draw_file!(order_presenter)
    ...
    move_cursor_to 685
    text_box seller_presenter.company_name, :at => [95, cursor], :width => 170, :size => 10, :height =>  10, :overflow => :shrink_to_fit
    text_box seller_presenter.name, :at => [338, cursor], :width => 170, :size => 10, :height =>  10, :overflow => :shrink_to_fit

    move_cursor_to 660
    text_box seller_presenter.document_type, :at => [95, cursor], :width => 170, :size => 10, :height =>  10, :overflow => :shrink_to_fit

    move_cursor_to 660
    text_box seller_presenter.nit_number, :at => [338, cursor], :width => 170, :size => 10, :height =>  10, :overflow => :shrink_to_fit

    move_cursor_to 634
    text_box seller_presenter.document_number, :at => [95, cursor], :width => 170, :size => 10, :height =>  10, :overflow => :shrink_to_fit

    move_cursor_to 607
    text_box seller_presenter.rucom_number, :at => [95, cursor], :width => 170, :size => 10, :height =>  10, :overflow => :shrink_to_fit

    move_cursor_to 633
    text_box seller_presenter.address, :at => [338, cursor], :width => 170, :size => 10, :height =>  10, :overflow => :shrink_to_fit

    move_cursor_to 607
    text_box seller_presenter.email, :at => [338, cursor], :width => 170, :size => 10, :height =>  10, :overflow => :shrink_to_fit

    move_cursor_to 580
    text_box seller_presenter.phone_number, :at => [95, cursor], :width => 170, :size => 10, :height =>  10, :overflow => :shrink_to_fit
