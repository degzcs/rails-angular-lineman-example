class Shipment::ProofOfShipment::GenerationService
  ...
  def call(options={})
    ...
    @draw_pdf_service_class = options[:draw_pdf_service] || ::Shipment::ProofOfShipment::DrawPDF
    timestamp = options[:timestamp] || Time.now.to_i
    response = {}

    temporal_folder_path = "#{ Rails.root }/tmp/shipment/#{ timestamp }"
