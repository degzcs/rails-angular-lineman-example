...
module V1
  module Entities
    class PopulationCenter < Grape::Entity
      ...
      expose :population_center_type, documentation: { type: "text", desc: "Population center type", example: "CP, C, IPM" }
      expose :population_center_code, documentation: { type: "text", desc: "Population center code", example: "05001000" }
