...
module V1
  module Entities
    class City < Grape::Entity
      ...
      expose :city_code, documentation: { type: "text", desc: "City code", example: "05001" } do |city, options|
        # TODO: upgrade frond-end to accept this the correct value
        city.code
      end
      expose :state_id, documentation: { type: "text", desc: "State id", example: "1" }
      expose :state_code, documentation: { type: "text", desc: "State code", example: "05" }do |city, options|
        # TODO: upgrade frond-end to accept this the correct value
        city.state.code
      end
    end
