ActiveAdmin.register User do
  ...
  permit_params :id, :email, :office_id, :password, :password_confirmation, :external, :rucom, profile_attributes: [ :first_name, :last_name , :document_number, :phone_number , :address, :rut_file, :photo_file, :mining_authorization_file, :legal_representative, :nit_number, :city_id, :user_id ]
