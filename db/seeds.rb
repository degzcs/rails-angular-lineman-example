...
settings.data = { monthly_threshold: 35, fine_gram_value: 2000, vat_percentage: 19, fixed_sale_agreetment: "fixed sale agreetment text", habeas_data_agreetment: "habeas agreetment text", ros_threshold: 2000000 }
settings.save!
...
trazoro_users = User.where(email: ['diego.gomez@trazoro.co', 'tech@trazoro.co', 'dgomez@trazoro.co', 'santiago.lopez@trazoro.co'])
...
begin
  legal_representative = User.find_by(email: 'dgomez@trazoro.co')
