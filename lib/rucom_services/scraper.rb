...
module RucomServices
  class Scraper
    # PAGE_URL = 
    #   'http://tramites.anm.gov.co:8080/Portal/pages/consultaListados/anonimoListados.jsf'
    # HIDDEN_ELEMENTS_ID = 
    #   { step_0: 'form:trol_panel', step_1: 'form:tIdentificacion_panel', step_2: 'form:numId'}
